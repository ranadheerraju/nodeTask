...
export const putSignupDetails = data => async dispatch => {
    await axios.post('http://13.232.169.125/user/signup', data)
        .then((response) => {
...
export const getUserDetails = token => async dispatch => {
    await axios.get('http://13.232.169.125/user/current', {
        headers: {
            'Authorization': token
        }
    }).then((response) => {
...
export const updateCurrentInteger = (data, token) => async dispatch => {
    await axios.put('http://13.232.169.125/user/update', data, {
        headers: {
            'Authorization': token
        }
    }).then((response) => {
